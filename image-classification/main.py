...
def main():
    ...
    if args.multiprocessing_distributed:
        ...
        main_worker(args.gpu, ngpus_per_node, args, owl)


def main_worker(gpu, ngpus_per_node, args, owl):
    global best_acc1
    args.gpu = gpu
    ...
    # Run OwLite convert
    example_input = torch.randn(args.batch_size // ngpus_per_node, 3, 224, 224).to(
        device
    )
